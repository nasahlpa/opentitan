...
export LR_SYNTH_TOP_MODULE="ibex_register_file_ff"

# SETUP CELL LIBRARY PATH
# Uncomment the lines below and set the path to an appropriate .lib file
export LR_SYNTH_CELL_LIBRARY_PATH=/home/pascal/Documents/projects/rf_analysis/opentitan/hw/vendor/lowrisc_ibex/syn/nangate.lib
