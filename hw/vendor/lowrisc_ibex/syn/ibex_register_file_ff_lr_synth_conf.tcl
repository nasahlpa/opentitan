...
# a flop.
set lr_synth_outputs [list {rdata_a_o   70.0} \
                           {rdata_b_o  70.0} \
                           {err_o  80.0}]

set lr_synth_inputs [list {test_en_i        0.0 } \
                          {dummy_instr_id_i 30.0} \
                          {dummy_instr_wb_i 30.0} \
                          {raddr_a_i        30.0} \
                          {raddr_b_i        30.0} \
                          {waddr_a_i        30.0} \
                          {wdata_a_i        30.0} \
...
# clock period in ps, this gives a 500 MHz clock.  using the nangate45 library
...
set lr_synth_clk_period 2000.0
...
set lr_synth_abc_clk_uprate 1000.0
