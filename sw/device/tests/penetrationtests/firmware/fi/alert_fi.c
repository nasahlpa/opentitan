...
status_t handle_alert_fi_trigger(ujson_t *uj) {
  ...
  switch (uj_trigger.alert) {
    case 0:
      dif_aes_alert_force(&aes, kDifAesAlertRecovCtrlUpdateErr);
      break;
    case 1:
      dif_aes_alert_force(&aes, kDifAesAlertFatalFault);
      break;
    case 2:
      dif_aon_timer_alert_force(&aon_timer_aon, kDifAonTimerAlertFatalFault);
      break;
    case 3:
      dif_clkmgr_alert_force(&clkmgr_aon, kDifClkmgrAlertRecovFault);
      break;
    case 4:
      dif_clkmgr_alert_force(&clkmgr_aon, kDifClkmgrAlertFatalFault);
      break;
    case 5:
      dif_csrng_alert_force(&csrng, kDifCsrngAlertRecovAlert);
      break;
    case 6:
      dif_csrng_alert_force(&csrng, kDifCsrngAlertFatalAlert);
      break;
    case 7:
      dif_edn_alert_force(&edn0, kDifEdnAlertRecovAlert);
      break;
    case 8:
      dif_edn_alert_force(&edn0, kDifEdnAlertFatalAlert);
      break;
    case 9:
      dif_edn_alert_force(&edn1, kDifEdnAlertRecovAlert);
      break;
    case 10:
      dif_edn_alert_force(&edn1, kDifEdnAlertFatalAlert);
      break;
    case 11:
      dif_entropy_src_alert_force(&entropy_src, kDifEntropySrcAlertRecovAlert);
      break;
    case 12:
      dif_entropy_src_alert_force(&entropy_src, kDifEntropySrcAlertFatalAlert);
      break;
    case 13:
      dif_flash_ctrl_alert_force(&flash_ctrl, kDifFlashCtrlAlertRecovErr);
      break;
    case 14:
      dif_flash_ctrl_alert_force(&flash_ctrl, kDifFlashCtrlAlertFatalStdErr);
      break;
    case 15:
      dif_flash_ctrl_alert_force(&flash_ctrl, kDifFlashCtrlAlertFatalErr);
      break;
    case 16:
      dif_flash_ctrl_alert_force(&flash_ctrl,
    ...
    case 17:
      ...
      break;
    case 18:
      dif_gpio_alert_force(&gpio, kDifGpioAlertFatalFault);
      break;
    case 19:
      dif_hmac_alert_force(&hmac, kDifHmacAlertFatalFault);
      break;
    case 20:
      dif_i2c_alert_force(&i2c0, kDifI2cAlertFatalFault);
      break;
    case 21:
      dif_i2c_alert_force(&i2c1, kDifI2cAlertFatalFault);
      break;
    case 22:
      dif_i2c_alert_force(&i2c2, kDifI2cAlertFatalFault);
      break;
    case 23:
      dif_keymgr_alert_force(&keymgr, kDifKeymgrAlertRecovOperationErr);
      break;
    case 24:
      dif_keymgr_alert_force(&keymgr, kDifKeymgrAlertFatalFaultErr);
      break;
    case 25:
      dif_kmac_alert_force(&kmac, kDifKmacAlertRecovOperationErr);
      break;
    case 26:
      dif_kmac_alert_force(&kmac, kDifKmacAlertFatalFaultErr);
      break;
    case 27:
      dif_lc_ctrl_alert_force(&lc_ctrl, kDifLcCtrlAlertFatalProgError);
      break;
    case 28:
      dif_lc_ctrl_alert_force(&lc_ctrl, kDifLcCtrlAlertFatalStateError);
      break;
    case 29:
      dif_lc_ctrl_alert_force(&lc_ctrl, kDifLcCtrlAlertFatalBusIntegError);
      break;
    case 30:
      dif_otbn_alert_force(&otbn, kDifOtbnAlertFatal);
      break;
    case 31:
      dif_otbn_alert_force(&otbn, kDifOtbnAlertRecov);
      break;
    case 32:
      dif_otp_ctrl_alert_force(&otp_ctrl, kDifOtpCtrlAlertFatalMacroError);
      break;
    case 33:
      dif_otp_ctrl_alert_force(&otp_ctrl, kDifOtpCtrlAlertFatalCheckError);
      break;
    case 34:
      dif_otp_ctrl_alert_force(&otp_ctrl, kDifOtpCtrlAlertFatalBusIntegError);
      break;
    case 35:
      dif_otp_ctrl_alert_force(&otp_ctrl, kDifOtpCtrlAlertFatalPrimOtpAlert);
      break;
    case 36:
      dif_otp_ctrl_alert_force(&otp_ctrl, kDifOtpCtrlAlertRecovPrimOtpAlert);
      break;
    case 37:
      dif_pattgen_alert_force(&pattgen, kDifPattgenAlertFatalFault);
      break;
    case 38:
      dif_pinmux_alert_force(&pinmux_aon, kDifPinmuxAlertFatalFault);
      break;
    case 39:
      dif_pwm_alert_force(&pwm_aon, kDifPwmAlertFatalFault);
      break;
    case 40:
      dif_pwrmgr_alert_force(&pwrmgr_aon, kDifPwrmgrAlertFatalFault);
      break;
    case 41:
      dif_rom_ctrl_alert_force(&rom_ctrl, kDifRomCtrlAlertFatal);
      break;
    case 42:
      dif_rstmgr_alert_force(&rstmgr_aon, kDifRstmgrAlertFatalFault);
      break;
    case 43:
      dif_rstmgr_alert_force(&rstmgr_aon, kDifRstmgrAlertFatalCnstyFault);
      break;
    case 44:
      dif_rv_core_ibex_alert_force(&rv_core_ibex,
    ...
    case 47:
      ...
      break;
    case 48:
      dif_rv_plic_alert_force(&rv_plic, kDifRvPlicAlertFatalFault);
      break;
    case 49:
      dif_rv_timer_alert_force(&rv_timer, kDifRvTimerAlertFatalFault);
      break;
    case 50:
      dif_sensor_ctrl_alert_force(&sensor_ctrl_aon,
    ...
    case 51:
      ...
      break;
    case 52:
      dif_spi_device_alert_force(&spi_device, kDifSpiDeviceAlertFatalFault);
      break;
    case 53:
      dif_spi_host_alert_force(&spi_host0, kDifSpiHostAlertFatalFault);
      break;
    case 54:
      dif_spi_host_alert_force(&spi_host1, kDifSpiHostAlertFatalFault);
      break;
    case 55:
      dif_sram_ctrl_alert_force(&sram_ctrl_main, kDifSramCtrlAlertFatalError);
      break;
    case 56:
      dif_sram_ctrl_alert_force(&sram_ctrl_ret_aon,
                                kDifSramCtrlAlertFatalError);
      break;
    case 57:
      dif_sysrst_ctrl_alert_force(&sysrst_ctrl_aon,
                                  kDifSysrstCtrlAlertFatalFault);
      break;
    case 58:
      dif_uart_alert_force(&uart0, kDifUartAlertFatalFault);
      break;
    case 59:
      dif_uart_alert_force(&uart1, kDifUartAlertFatalFault);
      break;
    case 60:
      dif_uart_alert_force(&uart2, kDifUartAlertFatalFault);
      break;
    case 61:
      dif_uart_alert_force(&uart3, kDifUartAlertFatalFault);
      break;
    case 62:
      dif_usbdev_alert_force(&usbdev, kDifUsbdevAlertFatalFault);
      break;
    default:
      LOG_ERROR("Wrong alert given");
...
status_t handle_alert_fi_sensor_ctrl_trigger(ujson_t *uj) {
  ...
  dif_sensor_ctrl_set_ast_event_trigger(&sensor_ctrl_aon, 0, kDifToggleEnabled);
...
status_t handle_alert_fi_ibex_sw_fatal(ujson_t *uj) {
  ...
  // Write to the CSR.
  dif_rv_core_ibex_trigger_sw_fatal_err_alert(&rv_core_ibex);
